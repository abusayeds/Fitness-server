...
const createPayment = catchAsync(async (req, res) => {
  const result = await paymentSerice.createPaymentDB(req.body);
  sendResponse(res, {
...
const confirmationController = async (req: Request, res: Response) => {
  ...
  await paymentSerice.confirmationService(transactionId as string);
...
const getAllPayment = catchAsync(async (req, res) => {
  const result = await paymentSerice.getAllPaymentDB();
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: "All Payment registered successfully",
    data: result,
  });
});
const deletePayment = catchAsync(async (req, res) => {
  const { id } = req.params;
  const result = await paymentSerice.deletePaymentDB(id);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
